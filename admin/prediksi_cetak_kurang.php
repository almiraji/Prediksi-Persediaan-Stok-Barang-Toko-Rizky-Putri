    ...
    <div class="rangkasurat">
      <table width="100%">
        <tr>
          ...
          <td class="tengah">
            <h3>LAPORAN DATA HASIL PREDIKSI KURANG DAN PERLU RESTOCK</h3>
      ...
      <table class="table table-bordered" id="tabel-data">
        ...
        <tbody>
          ...
          if ($_GET['bulan'] != 0 && !empty($_GET['tahun'])) {
            ...
            $query = mysqli_query($koneksi, "SELECT * FROM data_kategori a, data_barang b, data_hasil c WHERE b.id_kategori = a.id_kategori AND c.id_barang = b.id_barang $whereBulan ORDER BY c.id_hasil DESC");
          } else {
            $whereBulan = "";
