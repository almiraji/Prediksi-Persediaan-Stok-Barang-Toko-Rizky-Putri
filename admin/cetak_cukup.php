...
<body>
  ...
  if (!empty($_GET['bulan']) && !empty($_GET['tahun'])) {
    ...
    WHERE a.id_kategori = '$_GET[id_kategori]'
      ...
      AND c.hasil_prediksi = 'cukup'
    ORDER BY c.id_hasil DESC;
    ");
  } else {
    $query = mysqli_query($koneksi, "SELECT * FROM data_kategori a, data_barang b, data_hasil c WHERE b.id_kategori = a.id_kategori AND c.id_barang = b.id_barang AND MONTH(c.tanggal) = '$tanggalSebelumnya' AND c.hasil_prediksi = 'cukup' ORDER BY c.id_hasil DESC");
  }
  ?>
  <div class="container">
    ...
    <div class="subheader">LAPORAN STOK CUKUP<br>Bulan:Januari <br> Tahun:2024 </div>
    <div class="row mt-4">
