    ...
    <div class="rangkasurat">
      <table width="100%">
        <tr>
          ...
          <td class="tengah">
            <h3>LAPORAN DATA PENJUALAN BARANG</h3>
      ...
      if (isset($_GET['id_kategori'])) {
        ...
        echo "<h4 align='center'>LAPORAN DATA PENJUALAN BARANG UNTUK KATEGORI " . strtoupper($datakategori['kategori']) . "</h3>";
      }
      ?>
      <br>
      <table class="table table-bordered" id="tabel-data">
        ...
        <tbody>
          ...
          $no  = 1;
          if (isset($_GET['id_kategori'])) {
            $query = mysqli_query($koneksi, "SELECT * FROM data_barang b, data_penjualan c, data_kategori d WHERE c.id_barang = b.id_barang AND b.id_kategori = d.id_kategori AND b.id_kategori = '$_GET[id_kategori]' ORDER BY c.id_penjualan DESC");
          } else {
            $query = mysqli_query($koneksi, "SELECT * FROM data_barang b, data_penjualan c, data_kategori d WHERE c.id_barang = b.id_barang AND b.id_kategori = d.id_kategori ORDER BY c.id_penjualan DESC");
          }
